...
def assign_author():
    superauthor = User.objects.get(username='ernest_aitiev')
    return superauthor.id
...
class Article(models.Model):
    ...
    user_author = models.ForeignKey('auth.User', on_delete=models.PROTECT, related_name='articles', default=assign_author)
